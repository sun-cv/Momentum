...
namespace Momentum
{
    ...
    public struct InteractPress         : IInputEvent { public readonly ButtonInput Button => ButtonInput.Interact; }
    public struct InteractRelease       : IInputEvent { public readonly ButtonInput Button => ButtonInput.Interact; }
    ...
    public struct AimPress              : IInputEvent { public readonly ButtonInput Button => ButtonInput.Aim;      }
    public struct AimRelease            : IInputEvent { public readonly ButtonInput Button => ButtonInput.Aim;      }
