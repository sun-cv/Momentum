    ...
    public class Injector : MonoBehaviour {
        ...
        void Inject(object instance) {
            ...
            var injectableFields = type.GetFields(k_bindingFlags)
                .Where(member => System.Attribute.IsDefined(member, typeof(InjectAttribute)));
        ...
        void Register(IDependencyProvider provider) {
            ...
            foreach (var method in methods) {
                if (!System.Attribute.IsDefined(method, typeof(ProvideAttribute))) continue;
        ...
        public void ValidateDependencies() {
            ...
            var invalidDependencies = monoBehaviours
                ...
                .Where(t => System.Attribute.IsDefined(t.field, typeof(InjectAttribute)))
        ...
        static bool IsInjectable(MonoBehaviour obj) {
            ...
            return members.Any(member => System.Attribute.IsDefined(member, typeof(InjectAttribute)));
        }
    }
