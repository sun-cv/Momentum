...
//         public bool IsEligible(AbilityRequest request)          => !IsOnCooldown(request) && MeetsRequirements(request);
...
//         public bool IsExpiredEligible(AbilityRequest request)   => Time.time - request.Meta.TimeEligible  > request.EligibleBuffer;
