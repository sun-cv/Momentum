...
//         public AbilityExecutor Execute(Request request)
//         {
...
//             if (executor.instance.ability.mode == Mode.Exclusive)
...
//         public bool HasActiveStateExecutor(State state) => Active.Any((executor) => executor.instance.ability.requiredState == state );
