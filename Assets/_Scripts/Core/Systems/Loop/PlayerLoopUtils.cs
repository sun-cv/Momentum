...
namespace Momentum
{
    ...
    public static class PlayerLoopUtils
    {
        ...
        public static void RemoveSystem<T>(ref PlayerLoopSystem loop, in PlayerLoopSystem systemToRemove)
        {
            ...
            HandleSybSystemLoopForRemoval<T>(ref loop, systemToRemove);

        }

        static void HandleSybSystemLoopForRemoval<T>(ref PlayerLoopSystem loop, PlayerLoopSystem systemToRemove)
        {
            if (loop.subSystemList == null)
            {
                return;
