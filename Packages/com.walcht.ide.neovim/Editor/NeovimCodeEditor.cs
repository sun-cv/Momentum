...
namespace Neovim.Editor
{
  ...
  public class NeovimCodeEditor : IExternalCodeEditor
  {
    ...
    static string s_ServerSocket = File.Exists("C:/Ops/Config/nvim/scripts/Unity/nvim-port.txt") 
    ? $"127.0.0.1:{File.ReadAllText("C:/Ops/Config/nvim/scripts/Unity/nvim-port.txt").Trim()}"
    : "127.0.0.1:9999";
